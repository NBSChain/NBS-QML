...
Effect {
    ...
    property        string          vertexES            : "qrc:/UI/PageViews/IndexPage/shaders/es2/planetD.vert"; //
    property        string          fragmentES          : "qrc:/UI/PageViews/IndexPage/shaders/es2/planetD.frag";
    property        string          vertexGL            : "qrc:/UI/PageViews/IndexPage/shaders/gl3/planetD.vert";
    property        string          framentGL           : "qrc:/UI/PageViews/IndexPage/shaders/gl3/planetD.frag";
    ...
    RenderPass {
        ...
        shaderProgram       : ShaderProgram {
            ...
            fragmentShaderCode  : loadSource(framentGL);
